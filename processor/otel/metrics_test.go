...
func TestConsumeMetricsHostCPU(t *testing.T) {
	...
	assert.ElementsMatch(t, []model.APMEvent{{
		Agent:     agent,
		Service:   service,
		Labels:    common.MapStr{"state": "idle", "cpu": "0"},
		Timestamp: timestamp,
		Processor: model.MetricsetProcessor,
		Metricset: &model.Metricset{
			Samples: map[string]model.MetricsetSample{
		...
		Agent:     agent,
		Service:   service,
		Labels:    common.MapStr{"state": "system", "cpu": "0"},
		Timestamp: timestamp,
		Processor: model.MetricsetProcessor,
		Metricset: &model.Metricset{
			Samples: map[string]model.MetricsetSample{
		...
		Agent:     agent,
		Service:   service,
		Labels:    common.MapStr{"state": "user", "cpu": "0"},
		Timestamp: timestamp,
		Processor: model.MetricsetProcessor,
		Metricset: &model.Metricset{
			Samples: map[string]model.MetricsetSample{
		...
		Agent:     agent,
		Service:   service,
		Labels:    common.MapStr{"state": "idle", "cpu": "1"},
		Timestamp: timestamp,
		Processor: model.MetricsetProcessor,
		Metricset: &model.Metricset{
			Samples: map[string]model.MetricsetSample{
		...
		Agent:     agent,
		Service:   service,
		Labels:    common.MapStr{"state": "system", "cpu": "1"},
		Timestamp: timestamp,
		Processor: model.MetricsetProcessor,
		Metricset: &model.Metricset{
			Samples: map[string]model.MetricsetSample{
		...
		Agent:     agent,
		Service:   service,
		Labels:    common.MapStr{"state": "user", "cpu": "1"},
		Timestamp: timestamp,
		Processor: model.MetricsetProcessor,
		Metricset: &model.Metricset{
			Samples: map[string]model.MetricsetSample{
		...
		Agent:     agent,
		Service:   service,
		Labels:    common.MapStr{"state": "idle", "cpu": "2"},
		Timestamp: timestamp,
		Processor: model.MetricsetProcessor,
		Metricset: &model.Metricset{
			Samples: map[string]model.MetricsetSample{
		...
		Agent:     agent,
		Service:   service,
		Labels:    common.MapStr{"state": "system", "cpu": "2"},
		Timestamp: timestamp,
		Processor: model.MetricsetProcessor,
		Metricset: &model.Metricset{
			Samples: map[string]model.MetricsetSample{
		...
		Agent:     agent,
		Service:   service,
		Labels:    common.MapStr{"state": "user", "cpu": "2"},
		Timestamp: timestamp,
		Processor: model.MetricsetProcessor,
		Metricset: &model.Metricset{
			Samples: map[string]model.MetricsetSample{
		...
		Agent:     agent,
		Service:   service,
		Labels:    common.MapStr{"state": "idle", "cpu": "3"},
		Timestamp: timestamp,
		Processor: model.MetricsetProcessor,
		Metricset: &model.Metricset{
			Samples: map[string]model.MetricsetSample{
		...
		Agent:     agent,
		Service:   service,
		Labels:    common.MapStr{"state": "system", "cpu": "3"},
		Timestamp: timestamp,
		Processor: model.MetricsetProcessor,
		Metricset: &model.Metricset{
			Samples: map[string]model.MetricsetSample{
		...
		Agent:     agent,
		Service:   service,
		Labels:    common.MapStr{"state": "user", "cpu": "3"},
		Timestamp: timestamp,
		Processor: model.MetricsetProcessor,
		Metricset: &model.Metricset{
			Samples: map[string]model.MetricsetSample{
...
func TestConsumeMetricsHostMemory(t *testing.T) {
	...
	assert.ElementsMatch(t, []model.APMEvent{{
		Agent:     agent,
		Service:   service,
		Labels:    common.MapStr{"state": "free"},
		Timestamp: timestamp,
		Processor: model.MetricsetProcessor,
		Metricset: &model.Metricset{
			Samples: map[string]model.MetricsetSample{
		...
		Agent:     agent,
		Service:   service,
		Labels:    common.MapStr{"state": "used"},
		Timestamp: timestamp,
		Processor: model.MetricsetProcessor,
		Metricset: &model.Metricset{
			Samples: map[string]model.MetricsetSample{
